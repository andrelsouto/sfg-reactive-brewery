...
public class WebClientIT {
    ...
    void testUpdateBeer() throws InterruptedException {
        ...
        webClient.get().uri("/api/v1/beer")
                ...
                .subscribe(beerPagedList -> {
                    ...
                    webClient.put().uri(uriBuilder -> uriBuilder.path("/api/v1/beer/{id}").build(beerDto.getId()))
                            .accept(MediaType.APPLICATION_JSON)
                            .body(BodyInserters.fromValue(updatePayload))
                            .retrieve().toBodilessEntity()
                            .flatMap(responseEntity -> {
                                countDownLatch.countDown();
                                return webClient.get().uri(uriBuilder -> uriBuilder.path("/api/v1/beer/{id}").build(beerDto.getId()))
                                        .accept(MediaType.APPLICATION_JSON)
    ...
    void testUpdateBeerNotFound() throws InterruptedException {
        ...
        webClient.put().uri(uriBuilder -> uriBuilder.path("/api/v1/beer/{id}").build(200))
    ...
    void testDeleteBeer() throws InterruptedException {
        ...
        webClient.get().uri("/api/v1/beer")
                ...
                .subscribe(pagedList -> {
                    ...
                    webClient.delete().uri(uriBuilder -> uriBuilder.path("/api/v1/beer/{id}").build(beerDto.getId()))
                            .accept(MediaType.APPLICATION_JSON)
                            .retrieve().toBodilessEntity()
                            .flatMap(responseEntity -> {
                                countDownLatch.countDown();
